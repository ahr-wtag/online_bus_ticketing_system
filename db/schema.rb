...
ActiveRecord::Schema[7.0].define(version: 20_230_314_095_825) do
  ...
  create_table 'trips', force: :cascade do |t|
    ...
    t.date 'date', default: '2023-03-28', null: false
    t.time 'time', default: '2000-01-01 06:40:38', null: false
    t.bigint 'bus_id', null: false
